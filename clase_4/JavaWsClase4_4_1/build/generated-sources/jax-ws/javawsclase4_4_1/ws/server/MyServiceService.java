 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://ws.javawsclase3_3_5/", wsdlLocation = "http://localhost:8088/myServicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://ws.javawsclase3_3_5/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/myServicio?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://ws.javawsclase3_3_5/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.javawsclase3_3_5/", "MyServicePort"), MyService.class, features);
    }
